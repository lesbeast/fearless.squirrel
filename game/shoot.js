...
function bullet_collision() {
    ...
    for (var i = 0; i < player1.bullets.length; i++) {
        ...
        else if ((player1.bullets[i].position.x > ennemy1.position.x - 10 &&
            player1.bullets[i].position.x < ennemy1.position.x + 10 &&
            player1.bullets[i].position.y > ennemy1.position.y - 10 &&
            player1.bullets[i].position.y < ennemy1.position.y + 10) ||
            (player1.bullets[i].position.x < ennemy1.position.x - 10 &&
                player1.bullets[i].position.x > ennemy1.position.x + 10 &&
                player1.bullets[i].position.y < ennemy1.position.y - 10 &&
...
function player_collision() {
    ...
    else if ((player1.position.x > ennemy1.position.x - 10 &&
        player1.position.x < ennemy1.position.x + 10 &&
